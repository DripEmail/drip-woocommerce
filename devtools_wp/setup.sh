...
cd /var/www/html/ && \
/usr/local/bin/wp core install --url="http://localhost:3007" --title="drip_woocommerce_test" --admin_user="drip" --admin_email="drip@example.com" --admin_password="abc1234567890" --skip-email && \
